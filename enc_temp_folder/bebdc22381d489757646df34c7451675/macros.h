...
const std::string textures[NUM_OF_OBJECTS] = { "cleric1.png" , "knight1.png", "witch.png" ,"imp.png", "select.png", "fireProj.png" };

const std::vector<std::vector<int>> CharacterRowLengths = { {14,7,10,7,6,4} ,{12,8,8,5,6,4},
